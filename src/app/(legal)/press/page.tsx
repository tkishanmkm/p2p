...
export default function PressPage() {
  return (
    <div className="prose dark:prose-invert max-w-4xl mx-auto">
      <h1>Press & Media</h1>
      <p className="lead">
        Welcome to the Paxones press room. Here you will find the latest news, press releases, and media assets for our platform.
      </p>
      ...
      <p>
       ...
       <p>
        <strong>Email:</strong> press@paxones.app (Note: This is a fictional email address for demonstration.)
      </p>
      ...
      <div className="not-prose space-y-4 mt-6">
        <div className="p-4 border rounded-lg">
            ...
            <h3 className="font-semibold">Paxones Launches in Three New Markets, Expanding Global Reach</h3>
            <p className="mt-2 text-sm">Paxones today announced its expansion into three new emerging markets, furthering its mission to provide global access to peer-to-peer finance.</p>
        </div>
        <div className="p-4 border rounded-lg">
            <p className="text-sm text-muted-foreground">June 1, 2024</p>
            <h3 className="font-semibold">Paxones Reports Record Trading Volume in Q2 2024</h3>
