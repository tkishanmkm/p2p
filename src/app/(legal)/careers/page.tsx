...
export default function CareersPage() {
  return (
    <div className="prose dark:prose-invert max-w-4xl mx-auto">
      ...
      <p>
        At Tradenaire, you'll be part of a dynamic and fast-paced environment where your work has a real-world impact. We foster a culture of collaboration, ownership, and continuous learning. We are a remote-first company, offering the flexibility to work from anywhere.
      </p>
      ...
      <p>
        <strong>Email:</strong> careers@tradenaire.app (Note: This is a fictional email address for demonstration.)
      </p>
    </div>
  );
}
