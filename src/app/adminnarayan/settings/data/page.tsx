    ...
    const handleExport = async () => {
        ...
        try {
            for (const collectionName of COLLECTIONS_TO_BACKUP) {
                ...
                // This logic doesn't handle subcollections, which is a limitation but acceptable for this request.
                // A full backup would need recursive traversal.
            }
            ...
            a.href = url;
            a.download = `paxones-backup-${new Date().toISOString()}.json`;
    ...
    const handleImport = async () => {
        ...
        try {
            ...
            for (const collectionName of Object.keys(dataToImport)) {
                ...
                // We'll process in chunks of 499 to be safe.
        ...
        <div className="grid gap-6">
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>Download a full JSON backup of all major collections in your database. This does not include subcollections like trade messages or user wallets.</CardDescription>
                </CardHeader>
                <CardFooter>
            ...
            <Card className="border-destructive">
                <CardHeader>
                    ...
                    <CardDescription className="flex items-start gap-2 text-destructive">
                        ...
                        <div>
                            <span className="font-bold">Warning:</span> This is a destructive and irreversible action. Uploading a file will overwrite existing data with the contents of the backup file.
                        </div>
                    </CardDescription>
                </CardHeader>
