...
function BuyPageContent() {
  ...
  useEffect(() => {
    ...
    // Using replace to avoid adding to browser history on every filter change
  ...
  const pageTitle = `Buy ${selectedCoin === 'BTC' ? 'Bitcoin' : selectedCoin === 'ETH' ? 'Ethereum' : selectedCoin === 'LTC' ? 'Litecoin' : 'Tether'}`;
